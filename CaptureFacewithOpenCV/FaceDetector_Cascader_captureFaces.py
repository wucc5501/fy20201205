# -*- coding: utf-8 -*-
"""
Created on Tue Jan  7 21:11:10 2020
...
def CatchPICFromVideo(window_name, camera_idx, catch_pic_num, path_name):
    ...
    #告訴OpenCV使用人臉識別分類器
    #classfier = cv2.CascadeClassifier("D:\\ProgramInD\\OpenCV\\build\\etc\\haarcascades\\haarcascade_frontalface_alt2.xml")
...
if __name__ == '__main__':
    if len(sys.argv) != 1:
        ...
        #CatchPICFromVideo("擷取人臉", 0, 1000, 'faces\\face1')
        CatchPICFromVideo("Capture Face", 0, 1000, 'faces\\face1')