...
classesFile = "coco.names"      #"C:\\FRecognition\\OnlyYOLO\\coco.names" 
classes = None
with open(classesFile, 'rt') as f:
    classes = f.read().rstrip('\n').split('\n')

# Give the configuration and weight files for the model and load the network using them.
modelConfiguration = "yolov3.cfg"          #"C:\\FRecognition\\OnlyYOLO\\yolov3.cfg";
modelWeights = "yolov3.weights"   #"C:\\FRecognition\\OnlyYOLO\\yolov3.weights";
